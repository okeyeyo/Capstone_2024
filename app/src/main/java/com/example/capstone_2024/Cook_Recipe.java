...
public class Cook_Recipe extends AppCompatActivity {
    ...
    public void openIngredientActivity() {
        Intent intent = new Intent(Cook_Recipe.this, Cook_Ingredient.class);
        startActivity(intent);
    }
    public void openRecipeActivity() {
        Intent intent = new Intent(Cook_Recipe.this, Cook_Recipe.class);
        startActivity(intent);
    }
    public void openFavoritesActivity() {
        Intent intent = new Intent(Cook_Recipe.this, Cook_Favorites.class);
        startActivity(intent);
    }
}
