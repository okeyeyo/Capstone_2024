...
public class st_waish extends AppCompatActivity {
    ...
    public void btn_popup_set(){
        ...
        btn[0].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showDialog("1. 한 손을 내려놓고 손바닥이 위를 향하도록 합니다.\n" +
        ...
        btn[3].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showDialog("1. 한 손의 손가락을 다른 손으로 잡아 깍지에 끼도록 합니다.\n" +
        ...
        btn[4].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showDialog("1. 한 손을 다른 손으로 잡아주고 손바닥을 아래로 향하도록 합니다.\n" +
                        ...
                        "4. 손등 전체에 대해 약 5-10분 동안 마사지를 진행합니다.f");
