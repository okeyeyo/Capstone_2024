...
public class st_knee extends AppCompatActivity {
    ...
    public void btn_popup_set(){
        ...
        btn[0].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showDialog("1. 평평한 바닥에 누워 등을 곧게 펴고 양쪽 다리를 펴서 바닥에 놓습니다.\n" +
        ...
        btn[2].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showDialog("1. 평평한 바닥에 서서 양손을 허리에 놓습니다. 등은 곧게 펴고, 어깨는 뒤로 넣어줍니다.\n" +
        ...
        btn[3].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showDialog("1. 평평한 바닥에 앉아서 다리를 뻗고 앞으로 편 상태로 자세를 취합니다. 등은 곧게 펴고 어깨는 내려놓은 상태로 유지합니다.\n" +
        ...
        btn[4].setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                showDialog("1. 평평한 바닥에 등을 대고 누워서 자세를 취합니다. 양 다리를 펴고 발을 바닥에 딱 붙여놓습니다.\n" +
